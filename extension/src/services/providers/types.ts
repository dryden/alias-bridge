export interface AliasProvider {
    ...
    createAlias?(alias: string, token: string, domain?: string, hostname?: string, baseUrl?: string): Promise<{ success: boolean; error?: string; isCatchAllDomain?: boolean; createdAlias?: string }>;
}
